                ...
                <div class="row">
                  <div class="col-xs-6">
                    <ul class="list-unstyled l-h-2x">
                      <li>
                        <a href>
                          <i class="fa fa-fw fa-angle-right text-muted m-r-xs"/>Profile
                        </a>
                      </li>
                      <li>
                        <a href>
                          <i class="fa fa-fw fa-angle-right text-muted m-r-xs"/>Post
                        </a>
                      </li>
                      <li>
                        <a href>
                          <i class="fa fa-fw fa-angle-right text-muted m-r-xs"/>Search
                        </a>
                      </li>
                      <li>
                        <a href>
                          <i class="fa fa-fw fa-angle-right text-muted m-r-xs"/>Invoice
                        </a>
                      </li>
                    </ul>
                  </div>
                  <div class="col-xs-6">
                    <ul class="list-unstyled l-h-2x">
                      <li>
                        <a href>
                          <i class="fa fa-fw fa-angle-right text-muted m-r-xs"/>Price
                        </a>
                      </li>
                      <li>
                        <a href>
                          <i class="fa fa-fw fa-angle-right text-muted m-r-xs"/>Lock screen
                        </a>
                      </li>
                      <li>
                        <a href>
                          <i class="fa fa-fw fa-angle-right text-muted m-r-xs"/>Sign in
                        </a>
                      </li>
                      <li>
                        <a href>
                          <i class="fa fa-fw fa-angle-right text-muted m-r-xs"/>Sign up
                        </a>
                      </li>
                    </ul>
                  </div>
                ...
                <div class="row">
                  <div class="col-xs-6">
                    <ul class="list-unstyled l-h-2x">
                      <li>
                        <a href>
                          <i class="fa fa-fw fa-angle-right text-muted m-r-xs"/>Buttons
                        </a>
                      </li>
                      <li>
                        <a href>
                          <i class="fa fa-fw fa-angle-right text-muted m-r-xs"/>Icons
                          <span class="badge badge-sm bg-warning">1000+</span>
                        </a>
                      </li>
                      <li>
                        <a href>
                          <i class="fa fa-fw fa-angle-right text-muted m-r-xs"/>Grid
                        </a>
                      </li>
                      <li>
                        <a href>
                          <i class="fa fa-fw fa-angle-right text-muted m-r-xs"/>Widgets
                        </a>
                      </li>
                    </ul>
                  </div>
                  <div class="col-xs-6">
                    <ul class="list-unstyled l-h-2x">
                      <li>
                        <a href>
                          <i class="fa fa-fw fa-angle-right text-muted m-r-xs"/>Bootstap
                        </a>
                      </li>
                      <li>
                        <a href>
                          <i class="fa fa-fw fa-angle-right text-muted m-r-xs"/>Sortable
                        </a>
                      </li>
                      <li>
                        <a href>
                          <i class="fa fa-fw fa-angle-right text-muted m-r-xs"/>Portlet
                        </a>
                      </li>
                      <li>
                        <a href>
                          <i class="fa fa-fw fa-angle-right text-muted m-r-xs"/>Timeline
                        </a>
                      </li>
                    </ul>
                  </div>
